		...
		$scope.examList = {
			...
			columnDefs: [
				...
				{ 
					...
					filterHeaderTemplate: '<select id="dept_name" class="form-control" ng-change="grid.appScope.filter(\'dept_id\', dept_id, \'exam_view\', \'examList\',true, grid.appScope.examParams)" ng-model="dept_id" ng-options="item.id as item.dept_name for item in grid.appScope.departmentList">'
				...
				},
				{
					name:'day',width:50,
					enableSorting: false,
					filterHeaderTemplate: '<select id="day" class="form-control" ng-change="grid.appScope.filter(\'day\', day, \'exam_view\', \'examList\',true, grid.appScope.examParams);grid.appScope.examday = grid.appScope.campusConfig[day]" ng-model="day">'
				...
				{ name:'Manage',
					filterHeaderTemplate: '<select id="status" class="form-control" ng-change="grid.appScope.filter(\'status\', status, \'exam_view\', \'examList\',true, grid.appScope.examParams)" ng-model="status">'
