		...
		$rootScope.moduleMenus = [
		
			{
				...
				path : "#/dashboard/hr/staff",
				 events : {
					click : function(){
						return $scope.openModal("modules/hr/staff/addstaff.html");
					}
				} 
			},
                ...
                },
			   {
			    ...
			    { 
				 ...
				 filter: {
					...
					cellTemplate : 
					'<a ng-click="grid.appScope.openModal(\'modules/hr/staff/view_staff.html\',row.entity)" class="btn btn-primary btn-sm" type="button" tooltip-animation="true" tooltip="view Staff" > <span class="glyphicon glyphicon-user"></span></a>'
					+
					'<a ng-click="grid.appScope.openModal(\'modules/hr/staff/addstaff.html\',row.entity)" class="btn btn-primary btn-sm" type="button" tooltip-animation="true" tooltip="Edit staff" > <span class="glyphicon glyphicon-pencil"></span></a>'
					+
