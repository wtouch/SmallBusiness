	...
	$.fn.bxSlider = function(options){		
		...
		function showControls(nextType, nextContent, prevType, prevContent){
			...
			if(nextType == 'text'){
				...
				$nextHtml.html('<img src="../../../_script/slider/source/'+nextContent+'" />');
			}
			// check if prev is 'text' or 'image'
			if(prevType == 'text'){
				$prevHtml.html(prevContent);
			}else{
				$prevHtml.html('<img src="../../../_script/slider/source/'+prevContent+'" />');
			}
		...
		function showAutoControls(startType, startContent, stopType, stopContent){
			...
			if(startType == 'text'){
				...
				$startContent = '<img src="../../../_script/slider/source/'+startContent+'" />';
			}
			// check if stop is 'text' or 'image'
			if(stopType == 'text'){
				$stopContent = stopContent;
			}else{
				$stopContent = '<img src="../../../_script/slider/source/'+stopContent+'" />';
			}
			// check if user supplied a selector to populate next control
